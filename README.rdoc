...
jslint documentation (http://www.jslint.com/lint.html#options) for allowed
options and an example at http://github.com/smparkes/env-js/blob/envjsrb/.jslintrbrc.
...
warning. Note that this does not imply an endorsement of the use of
with statements.
